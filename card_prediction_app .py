...
Original file is located at
    https://colab.research.google.com/drive/11uBfHOoklADyxlPRx_t2hvWGPAH2p-h4
"""
...
def load_and_train_model(uploaded_file):
    ...
    # --- 2. TRAINING ---
    # FIX: Added class_weight='balanced' to handle the fact that Platinum is rare.
    # FIX: Increased n_estimators and removed max_depth to learn complex patterns.
...
if submit:
    ...
    colors = {
        ...
        "Platinum": "#E5E4E2"    # Platinum (Metallic White)
    }
    ...
    with c_explain_2:
        ...
        if prediction in ["Gold", "Platinum"]:
            if input_data['Total_Trans_Amt'].values[0] > 7000:
                explanations.append(f"**High Transaction Volume**<br>Total spend of ${input_data['Total_Trans_Amt'].values[0]:,.0f} places this customer in the top tier.")
            ...
            if input_data['Total_Trans_Ct'].values[0] > 80:
                explanations.append(f"**High Frequency**<br>{input_data['Total_Trans_Ct'].values[0]} transactions indicate high engagement.")
        ...
        if explanations:
            ...
            <div class="highlight-box">
                This customer's profile matches the standard characteristics of the <b>{prediction}</b> segment.
            </div>
            """, unsafe_allow_html=True)
